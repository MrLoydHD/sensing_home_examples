  ...
  return (
    <div className="space-y-20">
      ...
      <section className="flex flex-col items-center text-center py-20 gap-5">
        ...
        <h1 className="text-5xl font-bold text-foreground max-w-4xl">
      ...
      <LazyLoad>
        <section id="about" className="container mx-auto">
          <Card className="p-10 bg-muted border-0">
            <CardContent className="p-0">
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-primary w-10 h-10 rounded-full flex justify-center items-center text-primary-foreground">
                  <Info size={20} />
                </div>
